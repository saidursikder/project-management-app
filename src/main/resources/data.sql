...
-- INSERT PROJECTS
insert into project (project_id, name, stage, description, start_date, end_date) values (1000, 'Large Production Deploy', 'NOTSTARTED', 'This requires all hands on deck for the final deployment of the software into production', DATE '2019-03-04', DATE '2020-12-06');
insert into project (project_id, name, stage, description, start_date, end_date) values (1001, 'New Employee Budget',  'COMPLETED', 'Decide on a new employee bonus budget for the year and figureout who will be promoted', DATE '2020-03-04', DATE '2021-02-04');
insert into project (project_id, name, stage, description, start_date, end_date) values (1002, 'Office Reconstruction', 'INPROGRESS', 'The office building in Monroe has been damaged due to hurricane in the region. This needs to be reconstructed', DATE '2020-09-04', DATE '2022-10-04');
insert into project (project_id, name, stage, description, start_date, end_date) values (1003, 'Improve Intranet Security', 'INPROGRESS', 'With the recent data hack, the office security needs to be improved and proper security team needs to be hired for implementation', DATE '2021-01-04', DATE '2022-12-04');
